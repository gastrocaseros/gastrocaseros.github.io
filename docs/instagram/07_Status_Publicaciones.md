...
1. **Exportar Todo:** Ejecutar `node ig_posts/export.js` y `export_video.js` para generar los archivos finales con la nueva numeración.
2. **Publicación Post 4:** Subir el post de Ubicación (PNG) y la Historia 3 (MP4) para completar el Highlight de Ubicación.
3. **Seguimiento:** Continuar con la Serie Diagnóstica (Posts 5 y 6).
